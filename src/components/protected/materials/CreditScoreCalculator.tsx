...
const CreditScoreCalculator: React.FC = () => {
  ...
  const calculateCreditScore = (): number => {
    ...
    const maxScore = 850;
    const minScore = 300;
    const scoreRange = maxScore - minScore; // 550 points

    factors.forEach(factor => {
      let factorScore = 0;
      const weightedContribution = (factor.weight / 100) * scoreRange; // Points this factor can contribute
      ...
      switch (factor.id) {
        ...
        case 'utilization':
          ...
          else if (utilizationValue <= 30) factorScore = 0.8;
          else if (utilizationValue <= 50) factorScore = 0.5;
          else if (utilizationValue <= 75) factorScore = 0.3;
        ...
        case 'history':
          ...
          else if (historyValue >= 7) factorScore = 0.9;
          else if (historyValue >= 5) factorScore = 0.8;
