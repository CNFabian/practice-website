// Phaser-specific asset sub-barrel
// Only Phaser game engine assets — imported by PreloaderScene.ts

// Neighborhood assets (MapScene)
...
// House assets (NeighborhoodScene + HouseScene)
...
// Tree stages (GrowYourNest minigame)
