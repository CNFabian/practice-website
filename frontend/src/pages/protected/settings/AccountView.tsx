      ...
      <div>
        ...
        <div className="pb-6">
          <div className="flex items-center gap-6">
            <div className="w-20 h-20 rounded-full bg-light-background-blue flex items-center justify-center opacity-100">
              <svg className="w-10 h-10 text-unavailable-button" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
            </div>
            <div className="flex-1">
              <OnestFont as="h3" weight={700} lineHeight="relaxed" className="text-base text-text-blue-black mb-1">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="px-4 py-2 bg-elegant-blue rounded-lg text-sm font-medium text-white shadow-sm hover:opacity-90 transition-opacity"
              >
        ...
        <div className="border-t border-light-background-blue py-6">
          <OnestFont as="h3" weight={700} lineHeight="relaxed" className="text-base text-text-blue-black mb-4">
            Full Name
          </OnestFont>
