  ...
  return (
    <div className="w-full h-full relative overflow-hidden">
      ...
      <div className="absolute top-4 right-4 z-10">
        <button
          onClick={onMinigameSelect}
          disabled={isTransitioning}
          className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white backdrop-blur-sm rounded-lg shadow-lg hover:bg-blue-700 transition-colors disabled:opacity-50"
        >
