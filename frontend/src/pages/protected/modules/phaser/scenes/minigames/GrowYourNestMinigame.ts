...
export default class GrowYourNestMinigame extends Phaser.Scene {
  ...
  private createLeftPanel(x: number, y: number, panelWidth: number, panelHeight: number): void {
    ...
    // Stage text on the left - UPDATED TO ONEST
    // BEFORE (Arial):
    ...
    // Progress text on top of the progress bar (right aligned) - UPDATED TO ONEST
    // BEFORE (Arial):
  ...
  private showCompletion(): void {
    ...
    // COMPLETION SCREEN - ALL FONT REFERENCES UPDATED TO ONEST
